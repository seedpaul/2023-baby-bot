...
public class NavX extends SubsystemBase {
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("NAVX rate", this.getRate());
    ...
    SmartDashboard.putNumber("NAVX getRotation2d.getDegrees", this.getRotation2d().getDegrees());
    SmartDashboard.putNumber("NAVX getRotation2d.getRadians", this.getRotation2d().getRadians());
  }
